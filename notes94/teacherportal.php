...
if (!isset($_SESSION['email'])) {
	...
	//echo $user_email;
	$query    = "select * from tech_signup where email= '$user_email'";
		...
		<div class="container" style="margin-top:30px">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<strong>Welcome
						<?php echo $username; ?> Upload your Notes
					</strong>
									...
									<tbody>
										...
										while (($result = mysqli_fetch_assoc($squery))) {
											...
											<tr>
												...
												<td>
													<?php echo '<a href="display_pdf.php?id=' . $result['id'] . '&name=' . $result['filename'] . '">' . $result['filename'] . '</a>'; ?>
												</td>
												<td>
													<?php echo '<a href="deleteNotes.php?id=' . $result['id'] . '&name=' . $result['filename'] . '">' . "Delete" . '</a>'; ?>
												</td>
											</tr>
											<?php
										}
